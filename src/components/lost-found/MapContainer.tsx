          ...
          {mapPins.map((pin) => {
            ...
            return (
              ...
              >
                ...
                {/* Hover Tooltip - Fixed positioning and z-index */}
                {hoveredPin === pin.id && (
                  <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 z-50">
                    <div className="bg-white rounded-kawaii shadow-xl border-2 border-kawaii-pink/30 p-4 min-w-[280px] max-w-[320px] animate-slide-in">
                      <div className="text-center">
                        {/* Status Badge */}
                        <div className="flex items-center justify-center gap-1 mb-3">
                          {pin.pet.status === 'lost' ? (
                            <Paw size={16} className="text-kawaii-coral" />
                          ) : (
                        ...
                        {/* Pet Name */}
                        {pin.pet.name && (
                          <h4 className="font-bold text-gray-800 text-lg mb-2">{pin.pet.name}</h4>
                        )}
                        
                        {/* Location */}
                        <div className="flex items-center justify-center gap-1 mb-2">
                          <MapPin size={14} className="text-kawaii-blue-dark" />
                          <span className="text-sm text-gray-600 font-quicksand">{pin.pet.location}</span>
                        </div>
                        
                        {/* Description */}
                        <p className="text-sm text-gray-700 mb-3 line-clamp-2 font-quicksand leading-relaxed">
                          {pin.pet.description}
                        </p>
                        ...
                        <div className="flex items-center justify-center gap-1 text-sm text-gray-500">
                          <Calendar size={14} />
                          <span className="font-quicksand">{formatDate(pin.pet.date)}</span>
                        </div>
                        
                        {/* Click hint */}
                        <div className="mt-3 pt-2 border-t border-gray-200">
                          <p className="text-xs text-gray-500 font-quicksand">Click to view details</p>
                        </div>
                      </div>
